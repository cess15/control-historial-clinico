<a class="btn btn-info" href="{{ route('medicos.edit',$id) }}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ¿Esta seguro que desea eliminar a {{$nombres}} {{$apellidos}}?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
                <a href="{{ route('medicos.delete',$id)}}" class="btn btn-success">Confirmar</a>
            </div>
        </div>
    </div>
</div>