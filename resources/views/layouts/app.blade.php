...
<div class="w3-top">
  <div class="w3-bar w3-green w3-card" id="myNavbar">
    <a href="#home" class="w3-bar-item w3-wide"><img src="{{ asset('img/logoCAFSI.png') }}" class="rounded mx-auto d-block" style="width:40px;"></a>
...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-left w3-text-white" style="padding:48px">
    <div class="container">
      <h1><span class="w3-jumbo w3-hide-small w3-hide-medium text text-dark">Centro de Atención y Formación en Salud Integral</span></h1>
      <h1><span class="w3-jumbo w3-hide-small w3-hide-medium text text-dark">"Carlos Luis Morales Reina"</span></h1>
    </div>
    <h1><span class="w3-xxlarge w3-hide-large text text-dark">Centro de Atención y Formación en Salud Integral</span></h1>
    ...
    <p><a href="#about" class="w3-button w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-off">Conoce más de nosotros</a></p>
  </div> 
  <div class="w3-display-bottomleft w3-text-grey w3-large" style="padding:24px 48px">
    <a href="https://www.facebook.com/CAFSICLMR"><i class="fa fa-facebook-official w3-hover-opacity"></i></a>
    <a href="https://www.youtube.com/channel/UC3nWTALubXI8zgdjHG4EOuA"><i class="fa fa-youtube w3-hover-opacity"></i></a>
...
<footer class="w3-center w3-black w3-padding-64">
  ...
  <p>Copyright ©2020-{{ date('Y')+1 }} All right Reserved | This web design was made with ♥ by Andreina Pérez</p>
</footer>
